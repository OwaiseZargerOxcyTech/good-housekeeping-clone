...
const CommentForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-8 bg-slate-50 border rounded-md">
      ...
      <button
        type="submit"
        className="w-1/4 bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
        Submit
      </button>
    </form>
